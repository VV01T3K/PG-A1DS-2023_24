...
class Graph {
   public:
    ...
    /**
     * The function cyclesOf4 checks if the graph is bipartite and then counts
     * the number of cycles of length 4 accordingly.
     */
    void cyclesOf4() {
        if (isBipartite)
    ...
    /**
     * The function `countCyclesOf4` calculates the number of cycles of
     * length 4 in a graph based on the degrees and components of vertices.
     */
    void countCyclesOf4() {
        int64_t cyclesOf4 = 0;
